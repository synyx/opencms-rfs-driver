...
class RfsFolder extends CmsFolder implements RfsResource {
  
  private static final long serialVersionUID = 625843570471232490L;

  private String rfsPath;
  private String rfsBase;
  private String mountPath;
  
  public RfsFolder(CmsResource resource) {
    super(resource);
  }

  public RfsFolder(CmsUUID structureId, CmsUUID resourceId, String path,
      ...
      int version, String rfsPath, String rfsBase, String mountPath) {
